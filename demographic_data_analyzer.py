...
def calculate_demographic_data(print_data=True):
    ...
    country_earning = df[df['salary'] == '>50K']['native-country'].value_counts(normalize=False)
    country_total = df['native-country'].value_counts(normalize=False)
    country_earning_percentage = (country_earning / country_total * 100).dropna()
